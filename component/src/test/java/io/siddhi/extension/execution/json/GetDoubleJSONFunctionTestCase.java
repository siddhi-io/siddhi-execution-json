...
public class GetDoubleJSONFunctionTestCase {
    private static final Logger log = LogManager.getLogger(GetDoubleJSONFunctionTestCase.class);
    ...
    @Test
    public void testGetDoubleFromJSON() throws InterruptedException, ParseException {
        log.info("GetDoubleJSONFunctionExtension - testGetDoubleFromJSON");
        SiddhiManager siddhiManager = new SiddhiManager();
        String stream = "define stream InputStream(json string,path string);\n";
        String query = ("@info(name = 'query1')\n" +
                "from InputStream\n" +
                "select json:getDouble(json,path) as married\n" +
        ...
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    ...
                    switch (count.get()) {
                        case 1:
                            AssertJUnit.assertEquals(25.0, event.getData(0));
                            break;
                        case 2:
    ...
    @Test
    public void testGetDoubleFromJSONWithObjectInput() throws InterruptedException, ParseException {
        log.info("GetDoubleJSONFunctionExtension - testGetDoubleFromJSONWithObjectInput");
        SiddhiManager siddhiManager = new SiddhiManager();
