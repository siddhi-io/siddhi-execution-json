...
public class GetLongJSONFunctionTestCase {
    private static final Logger log = LogManager.getLogger(GetLongJSONFunctionTestCase.class);
    ...
    @Test
    public void testGetLongFromJSON() throws InterruptedException {
        log.info("GetLongJSONFunctionTestCase - testGetLongFromJSON");
        SiddhiManager siddhiManager = new SiddhiManager();
        String stream = "define stream InputStream(json string,path string);\n";
        String query = ("@info(name = 'query1')\n" +
                "from InputStream\n" +
                "select json:getLong(json,path) as married\n" +
        ...
        siddhiAppRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents,
                ...
                for (Event event : inEvents) {
                    ...
                    switch (count.get()) {
                        case 1:
                            AssertJUnit.assertEquals(new Long(25), event.getData(0));
                            break;
                        case 2:
    ...
    @Test
    public void testGetLongFromJSONWithObjectInput() throws InterruptedException, ParseException {
        log.info("GetLongJSONFunctionTestCase - testGetLongFromJSONWithObjectInput");
        SiddhiManager siddhiManager = new SiddhiManager();
